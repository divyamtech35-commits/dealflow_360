export const seedData = {
    ...
    categories: [
        { name: 'Hardware', defaultDiscountLimit: 10 },
        { name: 'Services', defaultDiscountLimit: 5 },
        { name: 'Subscriptions', defaultDiscountLimit: 15 },
    ],
    products: [
        { name: 'Pro Laptop 14"', sku: 'HW-LAP-14', category: 'Hardware', basePrice: 1200, unit: 'pcs', taxPercent: 10, costPrice: 900 },
        { name: '27" 4K Monitor', sku: 'HW-MON-27', category: 'Hardware', basePrice: 400, unit: 'pcs', taxPercent: 10, costPrice: 280 },
    ...
    discountRules: [
        { tier: 'Gold', maxDiscountPercent: 25, approvalRequiredAbove: 15, financeApprovalRequiredAbove: 20 },
